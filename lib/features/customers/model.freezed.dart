...
abstract class $CustomerCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String city, String id});
}
...
class _$_Customer implements _Customer {
  const _$_Customer({required this.name, required this.city, required this.id});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, city, id);
...
abstract class _Customer implements Customer {
  const factory _Customer(
      ...
      required final String id}) = _$_Customer;
